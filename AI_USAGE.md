...
### Phase 1 — Scaffolding — 2026-07-23 (commit `6ea8fcf`)
...
**Decision:** Edited — user removed equatable and added intl before approving. Three version/codegen issues discovered during build and fixed in-flight.

### Phase 2 — Domain layer — 2026-07-23
