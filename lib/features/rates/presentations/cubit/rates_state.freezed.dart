...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RatesState);
}
...
/// @nodoc
class $RatesStateCopyWith<$Res>  {
$RatesStateCopyWith(RatesState _, $Res Function(RatesState) __);
}


/// Adds pattern-matching-related methods to [RatesState].
extension RatesStatePatterns on RatesState {
...
class _Initial implements RatesState {
  const _Initial();
...
class _Loading implements RatesState {
  const _Loading();
...
/// @nodoc
abstract mixin class _$SuccessCopyWith<$Res> implements $RatesStateCopyWith<$Res> {
...
class _Empty implements RatesState {
  const _Empty();
...
class _Error implements RatesState {
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $RatesStateCopyWith<$Res> {
